...
const socket = io("https://barnes-occasions-kw-portfolio.trycloudflare.com"); // Your Cloudflare URL
      ...
      {!joinedRoom ? (
        ...
        <>
          ...
          <div className="mt-4 flex gap-4">
            <button onClick={startCall} className="px-4 py-2 bg-red-500 rounded">
              Start Call
            </button>
